...
Greek mathematics needed a transmissible system where results followed from explicit assumptions. This was an engineering problem in the broad sense: a repeated human difficulty had to be made tractable under constraints of notation, instruments, labor, materials, or institutions.
...
he organized definitions, postulates, common notions, and proofs into a durable deductive architecture. The system can be analyzed as inputs, representation, operations, checks, and outputs. Engineering history becomes clear when the contribution is read as a pipeline rather than as a slogan.
...
## Later systems
CAD, graphics, robotics geometry, formal proof, and engineering drawing. The modern connection should be understood through mechanism: what abstraction survived, what constraint disappeared, and what new system became possible.
