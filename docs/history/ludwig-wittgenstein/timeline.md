...
> Validation ID: VIA-HIST-LUDWIG-WITTGENSTEIN-TIMELINE  
> Version: 2.0  
...
Ludwig Wittgenstein belongs to the long history of philosophy. The central technical question is not merely what events occurred, but how a person working with the instruments, languages, institutions, and constraints of the period converted a hard problem into a teachable method. In this chapter, Ludwig Wittgenstein is treated as a node in engineering evolution: a contributor whose work changed how later people calculated, reasoned, measured, designed, governed, or built.
