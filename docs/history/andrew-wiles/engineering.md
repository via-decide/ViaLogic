...
- **Repository source:** `people/andrew-wiles/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Andrew Wiles is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about proof of Fermat’s Last Theorem into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/andrew-wiles/)
...
## Engineering problem
What recurring problem did this node address? For Andrew Wiles, ViaLogic currently points to: proof of Fermat’s Last Theorem.
