# Andrew Wiles — influence

- **Validation ID:** VIA-HIST-ANDREW-WILES-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Andrew Wiles; Andrew Wiles's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: proof of Fermat’s Last Theorem..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Andrew Wiles]
  Person --> Contribution[proof of Fermat’s Last Theorem.]
...
## Influenced by
- Earlier practitioners in number theory.
