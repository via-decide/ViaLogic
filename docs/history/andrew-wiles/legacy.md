...
- **Validation ID:** VIA-HIST-ANDREW-WILES-LEGACY
- **Version:** 1.1
...
## Engineering summary
Andrew Wiles's legacy is evaluated by whether proof of Fermat’s Last Theorem. became part of later technical reasoning, scientific education, institutional practice, or engineered systems.

## Historical summary
The historically safe starting point is the repository contribution marker: proof of Fermat’s Last Theorem.. Broader legacy claims require person-specific authoritative sources.
