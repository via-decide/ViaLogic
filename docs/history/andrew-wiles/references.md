# Andrew Wiles — references

- **Validation ID:** VIA-HIST-ANDREW-WILES-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Andrew Wiles. This page separates local repository evidence from authoritative source categories needed for future expansion.

## Historical summary
The local metadata records the following contribution marker: proof of Fermat’s Last Theorem.. Dates are recorded as birth `1953` and death `not specified in local metadata` when available in local metadata.

## Repository references
- `data/entities.json`
- profile path `people/andrew-wiles/` where available
- this history package under `docs/history/andrew-wiles/`
...
- **Contribution marker:** local history package and local metadata: proof of Fermat’s Last Theorem..
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Andrew Wiles.
