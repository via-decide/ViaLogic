...
> Validation ID: VIA-HIST-ARCHIMEDES-TIMELINE  
> Version: 2.0  
...
|---|---|---|
| c. 287 BCE | Birth or earliest biographical marker | Establishes the historical environment in which training and tools became available. |
...
| Main work | On Floating Bodies | Marks the period when the central method became visible to others. |
...
| 212 BCE | Death or later life marker | Separates the person’s work from its posthumous interpretation. |
...
Archimedes belongs to the long history of mechanics and mathematical physics. The central technical question is not merely what events occurred, but how a person working with the instruments, languages, institutions, and constraints of the period converted a hard problem into a teachable method. In this chapter, Archimedes is treated as a node in engineering evolution: a contributor whose work changed how later people calculated, reasoned, measured, designed, governed, or built.
...
## Technical problem
engineers needed quantitative laws for levers, centers of gravity, buoyancy, and approximation. Earlier approaches were limited because they depended on custom examples, authority, hand labor, local tradition, or qualitative explanation. A durable contribution had to make the work repeatable enough that later practitioners could test it, teach it, and extend it.

## Breakthrough and method
he joined geometric proof with mechanical reasoning, turning physical balance into mathematical argument. The engineering importance lies in the transfer from isolated insight to reusable procedure. A procedure can be inspected for assumptions, repeated under constraints, and adapted when instruments or social needs change.

## Mathematical or formal concepts
Key concepts include exhaustion method, hydrostatics, statics, approximation of pi, centers of mass. These ideas matter because mathematics is the compression layer of engineering history: it lets a community replace a pile of cases with a rule, a diagram, a proof, a table, a model, or an algorithm.
