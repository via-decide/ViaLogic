...
- **Validation ID:** VIA-HIST-ARCHIMEDES-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Archimedes; Archimedes's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: hydrostatics, levers, approximation methods..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Archimedes]
  Person --> Contribution[hydrostatics, levers, approximation methods.]
