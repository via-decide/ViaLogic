...
```mermaid
graph LR
  A[Earlier practices and inherited problems] --> B[Archimedes]
  B --> C[mechanics and mathematical physics]
  C --> D[mechanical design, naval architecture, calculus precursors, and mathematical modeling]
```

## Influenced by
Archimedes should be read against earlier tools, teachers, texts, institutions, and technical needs. Influence is strongest when a source shows direct reading, correspondence, apprenticeship, translation, patronage, or explicit criticism.
