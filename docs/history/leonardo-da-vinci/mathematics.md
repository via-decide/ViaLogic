...
- **Repository source:** `people/leonardo-da-vinci/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Leonardo Da Vinci is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Leonardo Da Vinci · Classical into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/leonardo-da-vinci/)
...
The verified mathematical object associated with this package is: Leonardo Da Vinci · Classical. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
