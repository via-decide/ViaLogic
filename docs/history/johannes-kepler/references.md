# Johannes Kepler — references

- **Validation ID:** VIA-HIST-JOHANNES-KEPLER-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Johannes Kepler. This page separates local repository evidence from authoritative source categories needed for future expansion.

## Historical summary
The local metadata records the following contribution marker: laws of planetary motion.. Dates are recorded as birth `1571` and death `1630` when available in local metadata.

## Repository references
- `data/entities.json`
- profile path `people/johannes-kepler/` where available
- this history package under `docs/history/johannes-kepler/`
...
- **Contribution marker:** local history package and local metadata: laws of planetary motion..
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Johannes Kepler.
