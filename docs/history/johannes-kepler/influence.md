# Johannes Kepler — influence

- **Validation ID:** VIA-HIST-JOHANNES-KEPLER-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Johannes Kepler; Johannes Kepler's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: laws of planetary motion..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Johannes Kepler]
  Person --> Contribution[laws of planetary motion.]
...
## Influenced by
- Earlier practitioners in astronomy and mathematics.
