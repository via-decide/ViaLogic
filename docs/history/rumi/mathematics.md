...
- **Repository source:** `people/rumi/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Rumi is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Rumi · Golden Age into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/rumi/)
...
The verified mathematical object associated with this package is: Rumi · Golden Age. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
