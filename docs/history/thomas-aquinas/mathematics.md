...
- **Repository source:** `people/thomas-aquinas/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Thomas Aquinas is represented in ViaLogic as a philosophy figure. The engineering knowledge package maps repository claims about Thomas Aquinas · Classical into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/thomas-aquinas/)
...
The verified mathematical object associated with this package is: Thomas Aquinas · Classical. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
