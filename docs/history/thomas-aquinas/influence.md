...
- **Validation ID:** VIA-HIST-THOMAS-AQUINAS-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Thomas Aquinas; Thomas Aquinas's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: Thomas Aquinas · Classical..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Thomas Aquinas]
  Person --> Contribution[Thomas Aquinas · Classical.]
