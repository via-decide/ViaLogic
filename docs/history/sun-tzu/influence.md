...
- **Validation ID:** VIA-HIST-SUN-TZU-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Sun Tzu; Sun Tzu's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: Sun Tzu · Classical..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Sun Tzu]
  Person --> Contribution[Sun Tzu · Classical.]
