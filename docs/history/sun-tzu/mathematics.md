...
- **Repository source:** `people/sun-tzu/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Sun Tzu is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Sun Tzu · Classical into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/sun-tzu/)
...
The verified mathematical object associated with this package is: Sun Tzu · Classical. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
