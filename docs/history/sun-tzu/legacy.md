...
- **Validation ID:** VIA-HIST-SUN-TZU-LEGACY
- **Version:** 1.1
...
## Engineering summary
Sun Tzu's legacy is evaluated by whether Sun Tzu · Classical. became part of later technical reasoning, scientific education, institutional practice, or engineered systems.

## Historical summary
The historically safe starting point is the repository contribution marker: Sun Tzu · Classical.. Broader legacy claims require person-specific authoritative sources.
