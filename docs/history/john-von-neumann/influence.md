...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into John Von Neumann; John Von Neumann's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: stored-program architecture; game theory; numerical methods..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[John Von Neumann]
  Person --> Contribution[stored-program architecture; game theory; numerical methods.]
...
## Influenced by
- Earlier practitioners in mathematics and computer architecture.
