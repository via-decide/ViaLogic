# Georg Hegel — references

- **Validation ID:** VIA-HIST-GEORG-HEGEL-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Georg Hegel. This page separates local repository evidence from authoritative source categories needed for future expansion.

## Historical summary
The local metadata records the following contribution marker: Georg Hegel · Enlightenment.. Dates are recorded as birth `not specified in local metadata` and death `not specified in local metadata` when available in local metadata.

## Repository references
- `data/entities.json`
- profile path `people/georg-hegel/` where available
- this history package under `docs/history/georg-hegel/`
...
- **Contribution marker:** local history package and local metadata: Georg Hegel · Enlightenment..
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Georg Hegel.
