...
- **Validation ID:** VIA-HIST-MARIE-CURIE-LEGACY
- **Version:** 1.1
...
## Engineering summary
Marie Curie's legacy is evaluated by whether radioactivity measurement and radium/polonium research. became part of later technical reasoning, scientific education, institutional practice, or engineered systems.

## Historical summary
The historically safe starting point is the repository contribution marker: radioactivity measurement and radium/polonium research.. Broader legacy claims require person-specific authoritative sources.
