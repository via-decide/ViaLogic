...
- **Validation ID:** VIA-HIST-MARIE-CURIE-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Marie Curie. This page separates local repository evidence from authoritative source categories needed for future expansion.

## Historical summary
The local metadata records the following contribution marker: radioactivity measurement and radium/polonium research.. Dates are recorded as birth `1867` and death `1934` when available in local metadata.

## Repository references
- `data/entities.json`
- profile path `people/marie-curie/` where available
- this history package under `docs/history/marie-curie/`
...
- **Contribution marker:** local history package and local metadata: radioactivity measurement and radium/polonium research..
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Marie Curie.
