...
## Who they were
Subhash Chandra Bose (repository does not specify–repository does not specify) is included because the repository associates them with historical knowledge.

## Historical context
Their work is documented here as part of a longer chain from theory to implementable engineering practice.

## Major contributions
- repository profile requires authoritative expansion.
