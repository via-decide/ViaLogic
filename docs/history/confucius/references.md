# Confucius — references

- **Validation ID:** VIA-HIST-CONFUCIUS-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Confucius. This page separates local repository evidence from authoritative source categories needed for future expansion.

## Historical summary
The local metadata records the following contribution marker: Confucius · Classical.. Dates are recorded as birth `not specified in local metadata` and death `not specified in local metadata` when available in local metadata.

## Repository references
- `data/entities.json`
- profile path `people/confucius/` where available
- this history package under `docs/history/confucius/`
...
- **Contribution marker:** local history package and local metadata: Confucius · Classical..
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Confucius.
