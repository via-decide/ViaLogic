...
- **Repository source:** `people/david-hilbert/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
David Hilbert is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about David Hilbert · Classical into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/david-hilbert/)
...
The verified mathematical object associated with this package is: David Hilbert · Classical. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
