# Benoit Mandelbrot — references

- **Validation ID:** VIA-HIST-BENOIT-MANDELBROT-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Benoit Mandelbrot. This page separates local repository evidence from authoritative source categories needed for future expansion.

## Historical summary
The local metadata records the following contribution marker: Benoit Mandelbrot · Modern.. Dates are recorded as birth `not specified in local metadata` and death `not specified in local metadata` when available in local metadata.

## Repository references
- `data/entities.json`
- profile path `people/benoit-mandelbrot/` where available
- this history package under `docs/history/benoit-mandelbrot/`
...
- **Contribution marker:** local history package and local metadata: Benoit Mandelbrot · Modern..
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Benoit Mandelbrot.
