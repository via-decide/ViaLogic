# Benoit Mandelbrot — influence

- **Validation ID:** VIA-HIST-BENOIT-MANDELBROT-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Benoit Mandelbrot; Benoit Mandelbrot's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: Benoit Mandelbrot · Modern..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Benoit Mandelbrot]
  Person --> Contribution[Benoit Mandelbrot · Modern.]
