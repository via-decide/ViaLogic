...
- **Repository source:** `people/benoit-mandelbrot/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Benoit Mandelbrot is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Benoit Mandelbrot · Modern into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/benoit-mandelbrot/)
...
## Who they were
Benoit Mandelbrot (repository does not specify–repository does not specify) is included because the repository associates them with science.
