...
- **Prerequisite era:** Concepts, institutions, instruments, or debates preceding Voltaire create the problem space in which the recorded contribution became meaningful.
- **Birth:** not specified in local metadata.
...
- **Major contribution period:** The repository records the contribution as: Voltaire · Classical..
