...
- **Repository source:** `people/maryam-mirzakhani/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Maryam Mirzakhani is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Maryam Mirzakhani · Modern into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/maryam-mirzakhani/)
...
## Who they were
Maryam Mirzakhani (repository does not specify–repository does not specify) is included because the repository associates them with science.
