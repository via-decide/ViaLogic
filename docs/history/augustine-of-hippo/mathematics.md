...
- **Repository source:** `people/augustine-of-hippo/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Augustine Of Hippo is represented in ViaLogic as a philosophy figure. The engineering knowledge package maps repository claims about Augustine Of Hippo · Classical into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/augustine-of-hippo/)
...
The verified mathematical object associated with this package is: Augustine Of Hippo · Classical. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
