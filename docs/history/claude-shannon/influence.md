...
```mermaid
graph LR
  A[Earlier practices and inherited problems] --> B[Claude Shannon]
  B --> C[information theory and switching circuits]
  C --> D[digital logic, compression, error correction, networks, cryptography, and data science]
```

## Influenced by
Claude Shannon should be read against earlier tools, teachers, texts, institutions, and technical needs. Influence is strongest when a source shows direct reading, correspondence, apprenticeship, translation, patronage, or explicit criticism.
