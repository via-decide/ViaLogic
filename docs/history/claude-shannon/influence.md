# Claude Shannon — influence

- **Validation ID:** VIA-HIST-CLAUDE-SHANNON-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Claude Shannon; Claude Shannon's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: Boolean switching circuits; mathematical theory of communication..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Claude Shannon]
  Person --> Contribution[Boolean switching circuits; mathematical theory of communication.]
...
## Influenced by
- Earlier practitioners in information theory and digital circuits.
