# Sardar Vallabhbhai Patel — influence

- **Validation ID:** VIA-HIST-SARDAR-VALLABHBHAI-PATEL-INFLUENCE
- **Version:** 1.0
...
```mermaid
graph LR
  prerequisites["Prerequisite traditions"] --> current["Sardar Vallabhbhai Patel"]
