...
## Who they were
Sardar Vallabhbhai Patel (repository does not specify–repository does not specify) is included because the repository associates them with historical knowledge.
