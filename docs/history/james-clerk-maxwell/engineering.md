...
- **Repository source:** `people/james-clerk-maxwell/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
James Clerk Maxwell is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Maxwell equations; field theory into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/james-clerk-maxwell/)
...
## Engineering problem
What recurring problem did this node address? For James Clerk Maxwell, ViaLogic currently points to: Maxwell equations; field theory.
