...
electricity, magnetism, and optics were experimentally rich but theoretically fragmented. This was an engineering problem in the broad sense: a repeated human difficulty had to be made tractable under constraints of notation, instruments, labor, materials, or institutions.
...
he expressed fields as coupled mathematical quantities and identified light with electromagnetic waves. The system can be analyzed as inputs, representation, operations, checks, and outputs. Engineering history becomes clear when the contribution is read as a pipeline rather than as a slogan.
...
## Later systems
radio, antennas, power systems, electronics, photonics, and wireless networks. The modern connection should be understood through mechanism: what abstraction survived, what constraint disappeared, and what new system became possible.
