# James Clerk Maxwell — timeline

> Validation ID: VIA-HIST-JAMES-CLERK-MAXWELL-TIMELINE  
> Version: 2.0  
...
|---|---|---|
| 1831 | Birth or earliest biographical marker | Establishes the historical environment in which training and tools became available. |
...
| Main work | A Dynamical Theory of the Electromagnetic Field | Marks the period when the central method became visible to others. |
...
| 1879 | Death or later life marker | Separates the person’s work from its posthumous interpretation. |
...
James Clerk Maxwell belongs to the long history of electromagnetism. The central technical question is not merely what events occurred, but how a person working with the instruments, languages, institutions, and constraints of the period converted a hard problem into a teachable method. In this chapter, James Clerk Maxwell is treated as a node in engineering evolution: a contributor whose work changed how later people calculated, reasoned, measured, designed, governed, or built.
...
## Technical problem
electricity, magnetism, and optics were experimentally rich but theoretically fragmented. Earlier approaches were limited because they depended on custom examples, authority, hand labor, local tradition, or qualitative explanation. A durable contribution had to make the work repeatable enough that later practitioners could test it, teach it, and extend it.

## Breakthrough and method
he expressed fields as coupled mathematical quantities and identified light with electromagnetic waves. The engineering importance lies in the transfer from isolated insight to reusable procedure. A procedure can be inspected for assumptions, repeated under constraints, and adapted when instruments or social needs change.

## Mathematical or formal concepts
Key concepts include vector field concepts, differential equations, wave propagation, statistical mechanics. These ideas matter because mathematics is the compression layer of engineering history: it lets a community replace a pile of cases with a rule, a diagram, a proof, a table, a model, or an algorithm.
