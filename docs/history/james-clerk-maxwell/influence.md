# James Clerk Maxwell — influence

- **Validation ID:** VIA-HIST-JAMES-CLERK-MAXWELL-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into James Clerk Maxwell; James Clerk Maxwell's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: Maxwell equations; field theory..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[James Clerk Maxwell]
  Person --> Contribution[Maxwell equations; field theory.]
...
## Influenced by
- Earlier practitioners in electromagnetism.
