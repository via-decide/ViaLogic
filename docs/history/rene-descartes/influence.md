...
- **Validation ID:** VIA-HIST-RENE-DESCARTES-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Rene Descartes; Rene Descartes's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: analytic geometry..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Rene Descartes]
  Person --> Contribution[analytic geometry.]
...
## Influenced by
- Earlier practitioners in mathematics and philosophy.
