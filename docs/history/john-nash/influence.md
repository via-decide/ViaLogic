...
- **Validation ID:** VIA-HIST-JOHN-NASH-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into John Nash; John Nash's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: John Nash · Modern..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[John Nash]
  Person --> Contribution[John Nash · Modern.]
