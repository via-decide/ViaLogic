...
- **Repository source:** `people/john-nash/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
John Nash is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about John Nash · Modern into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/john-nash/)
...
The verified mathematical object associated with this package is: John Nash · Modern. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
