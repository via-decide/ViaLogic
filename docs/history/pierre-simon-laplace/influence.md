# Pierre Simon Laplace — influence

- **Validation ID:** VIA-HIST-PIERRE-SIMON-LAPLACE-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Pierre Simon Laplace; Pierre Simon Laplace's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: Pierre Simon Laplace · Enlightenment..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Pierre Simon Laplace]
  Person --> Contribution[Pierre Simon Laplace · Enlightenment.]
