...
- **Repository source:** `people/niccolo-machiavelli/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Niccolo Machiavelli is represented in ViaLogic as a philosophy figure. The engineering knowledge package maps repository claims about Niccolo Machiavelli · Classical into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/niccolo-machiavelli/)
...
The verified mathematical object associated with this package is: Niccolo Machiavelli · Classical. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
