# Mahaviracharya — mathematics

- **Validation ID:** VIA-HIST-MAHAVIRACHARYA-MATHEMATICS
- **Version:** 1.0
...
The verified mathematical object associated with this package is: Mahaviracharya wrote Ganita Sara Sangraha, the first Sanskrit textbook on algebra.. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
