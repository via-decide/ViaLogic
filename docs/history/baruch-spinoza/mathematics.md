...
- **Repository source:** `people/baruch-spinoza/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Baruch Spinoza is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Baruch Spinoza · Enlightenment into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/baruch-spinoza/)
...
The verified mathematical object associated with this package is: Baruch Spinoza · Enlightenment. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
