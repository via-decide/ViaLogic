...
- **Repository source:** `people/joseph-louis-lagrange/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Joseph Louis Lagrange is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Joseph Louis Lagrange · Enlightenment into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/joseph-louis-lagrange/)
...
## Who they were
Joseph Louis Lagrange (repository does not specify–repository does not specify) is included because the repository associates them with science.
