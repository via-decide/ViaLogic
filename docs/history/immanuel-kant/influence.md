...
- **Repository source:** `people/immanuel-kant/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Immanuel Kant is represented in ViaLogic as a philosophy figure. The engineering knowledge package maps repository claims about Immanuel Kant · Enlightenment into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/immanuel-kant/)
...
```mermaid
graph LR
  prerequisites["Prerequisite traditions"] --> current["Immanuel Kant"]
  current --> contribution["Immanuel Kant · Enlightenment"]
