...
- **Repository source:** `people/srinivasa-ramanujan/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Srinivasa Ramanujan is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Self-taught genius with extraordinary number theory results. into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/srinivasa-ramanujan/)
...
## Mathematics used
- Arithmetic, geometry, logic, algebra, analysis, probability, mechanics, or field mathematics as applicable to Mathematician.

## Theories / algorithms / equations
The verified mathematical object associated with this package is: Self-taught genius with extraordinary number theory results.. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
