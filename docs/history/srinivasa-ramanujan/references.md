# Srinivasa Ramanujan — references

- **Validation ID:** VIA-HIST-SRINIVASA-RAMANUJAN-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Srinivasa Ramanujan. This page separates local repository evidence from authoritative source categories needed for future expansion.

## Historical summary
The local metadata records the following contribution marker: Self-taught genius with extraordinary number theory results.. Dates are recorded as birth `not specified in local metadata` and death `not specified in local metadata` when available in local metadata.

## Repository references
- `data/entities.json`
- profile path `people/srinivasa-ramanujan/` where available
- this history package under `docs/history/srinivasa-ramanujan/`
...
- **Contribution marker:** local history package and local metadata: Self-taught genius with extraordinary number theory results..
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Srinivasa Ramanujan.
