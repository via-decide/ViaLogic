# Brian Greene — influence

- **Validation ID:** VIA-HIST-BRIAN-GREENE-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Brian Greene; Brian Greene's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: Brian Greene · Modern..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Brian Greene]
  Person --> Contribution[Brian Greene · Modern.]
