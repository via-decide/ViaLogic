# Andrey Kolmogorov — influence

- **Validation ID:** VIA-HIST-ANDREY-KOLMOGOROV-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Andrey Kolmogorov; Andrey Kolmogorov's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: axiomatization of probability; complexity foundations..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Andrey Kolmogorov]
  Person --> Contribution[axiomatization of probability; complexity foundations.]
...
## Influenced by
- Earlier practitioners in probability and computation.
