# Andrey Kolmogorov — references

- **Validation ID:** VIA-HIST-ANDREY-KOLMOGOROV-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Andrey Kolmogorov. This page separates local repository evidence from authoritative source categories needed for future expansion.

## Historical summary
The local metadata records the following contribution marker: axiomatization of probability; complexity foundations.. Dates are recorded as birth `1903` and death `1987` when available in local metadata.

## Repository references
- `data/entities.json`
- profile path `people/andrey-kolmogorov/` where available
- this history package under `docs/history/andrey-kolmogorov/`
...
- **Contribution marker:** local history package and local metadata: axiomatization of probability; complexity foundations..
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Andrey Kolmogorov.
