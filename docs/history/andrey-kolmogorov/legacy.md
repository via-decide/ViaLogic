# Andrey Kolmogorov — legacy

- **Validation ID:** VIA-HIST-ANDREY-KOLMOGOROV-LEGACY
- **Version:** 1.1
...
## Engineering summary
Andrey Kolmogorov's legacy is evaluated by whether axiomatization of probability; complexity foundations. became part of later technical reasoning, scientific education, institutional practice, or engineered systems.

## Historical summary
The historically safe starting point is the repository contribution marker: axiomatization of probability; complexity foundations.. Broader legacy claims require person-specific authoritative sources.
