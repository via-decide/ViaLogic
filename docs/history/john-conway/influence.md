# John Conway — influence

- **Validation ID:** VIA-HIST-JOHN-CONWAY-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into John Conway; John Conway's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: John Conway · Classical..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[John Conway]
  Person --> Contribution[John Conway · Classical.]
