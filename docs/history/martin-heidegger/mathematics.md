...
- **Repository source:** `people/martin-heidegger/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Martin Heidegger is represented in ViaLogic as a philosophy figure. The engineering knowledge package maps repository claims about Martin Heidegger · Classical into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/martin-heidegger/)
...
The verified mathematical object associated with this package is: Martin Heidegger · Classical. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
