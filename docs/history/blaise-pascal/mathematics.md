...
- **Repository source:** `people/blaise-pascal/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Blaise Pascal is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Blaise Pascal · Enlightenment into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/blaise-pascal/)
...
The verified mathematical object associated with this package is: Blaise Pascal · Enlightenment. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
