...
- **Repository source:** `people/terence-tao/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Terence Tao is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Terence Tao · Modern into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/terence-tao/)
...
The verified mathematical object associated with this package is: Terence Tao · Modern. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
