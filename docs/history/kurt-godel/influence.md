...
```mermaid
graph LR
  A[Earlier practices and inherited problems] --> B[Kurt Godel]
  B --> C[mathematical logic]
  C --> D[limits of formal verification, computability theory, programming-language semantics, and theorem proving]
```

## Influenced by
Kurt Godel should be read against earlier tools, teachers, texts, institutions, and technical needs. Influence is strongest when a source shows direct reading, correspondence, apprenticeship, translation, patronage, or explicit criticism.
