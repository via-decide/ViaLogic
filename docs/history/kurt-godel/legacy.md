...
limits of formal verification, computability theory, programming-language semantics, and theorem proving. The durable legacy is not fame; it is the survival of a method. A method survives when it can be abstracted, taught, criticized, and recombined with later instruments.
