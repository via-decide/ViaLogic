...
- **Repository source:** `people/kurt-godel/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Kurt Godel is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about incompleteness theorems into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/kurt-godel/)
...
|---|---|---|
| 1906 | Birth / earliest historical marker. | External verification required in references. |
| Classical | Main period of work represented by ViaLogic. | Repository era metadata. |
| 1978 | Death / living status marker. | External verification required in references. |
