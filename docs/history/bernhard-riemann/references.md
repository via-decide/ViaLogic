# Bernhard Riemann — references

- **Validation ID:** VIA-HIST-BERNHARD-RIEMANN-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Bernhard Riemann. This page separates local repository evidence from authoritative source categories needed for future expansion.

## Historical summary
The local metadata records the following contribution marker: Riemannian geometry; zeta function.. Dates are recorded as birth `1826` and death `1866` when available in local metadata.

## Repository references
- `data/entities.json`
- profile path `people/bernhard-riemann/` where available
- this history package under `docs/history/bernhard-riemann/`
...
- **Contribution marker:** local history package and local metadata: Riemannian geometry; zeta function..
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Bernhard Riemann.
