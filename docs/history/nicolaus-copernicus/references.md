# Nicolaus Copernicus — references

- **Validation ID:** VIA-HIST-NICOLAUS-COPERNICUS-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Nicolaus Copernicus. This page separates local repository evidence from authoritative source categories needed for future expansion.

## Historical summary
The local metadata records the following contribution marker: heliocentric model.. Dates are recorded as birth `1473` and death `1543` when available in local metadata.

## Repository references
- `data/entities.json`
- profile path `people/nicolaus-copernicus/` where available
- this history package under `docs/history/nicolaus-copernicus/`
...
- **Contribution marker:** local history package and local metadata: heliocentric model..
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Nicolaus Copernicus.
