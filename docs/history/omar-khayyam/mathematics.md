...
- **Repository source:** `people/omar-khayyam/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Omar Khayyam is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Omar Khayyam · Golden Age into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/omar-khayyam/)
...
The verified mathematical object associated with this package is: Omar Khayyam · Golden Age. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
