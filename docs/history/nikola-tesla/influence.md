# Nikola Tesla — influence

- **Validation ID:** VIA-HIST-NIKOLA-TESLA-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Nikola Tesla; Nikola Tesla's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: AC power systems and induction motors..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Nikola Tesla]
  Person --> Contribution[AC power systems and induction motors.]
...
## Influenced by
- Earlier practitioners in electrical engineering.
