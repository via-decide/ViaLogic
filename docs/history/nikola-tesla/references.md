...
Begin with primary works where they survive. Then compare scholarly editions, official biographies, university histories, academy memoirs, and peer-reviewed histories. Use popular summaries only as signposts, never as final evidence for technical or historical claims.
