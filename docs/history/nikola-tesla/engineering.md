...
> Validation ID: VIA-HIST-NIKOLA-TESLA-ENGINEERING  
> Version: 2.0  
> Last reviewed: 2026-07-09

## The engineering problem
long-distance electrical distribution needed efficient voltage transformation and robust motors. This was an engineering problem in the broad sense: a repeated human difficulty had to be made tractable under constraints of notation, instruments, labor, materials, or institutions.
...
he developed polyphase alternating-current machinery and induction motor concepts. The system can be analyzed as inputs, representation, operations, checks, and outputs. Engineering history becomes clear when the contribution is read as a pipeline rather than as a slogan.
...
## Later systems
AC grids, electric motors, power electronics, industrial automation, and wireless experiments. The modern connection should be understood through mechanism: what abstraction survived, what constraint disappeared, and what new system became possible.
