...
computer architecture, arithmetic logic units, control flow, memory, and tabulation engineering. The durable legacy is not fame; it is the survival of a method. A method survives when it can be abstracted, taught, criticized, and recombined with later instruments.
