...
- **Repository source:** `people/charles-babbage/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Charles Babbage is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Difference Engine and Analytical Engine designs into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/charles-babbage/)
...
## Engineering problem
What recurring problem did this node address? For Charles Babbage, ViaLogic currently points to: Difference Engine and Analytical Engine designs.
