...
navigation, astronomy, and finance depended on error-prone hand-computed tables. This was an engineering problem in the broad sense: a repeated human difficulty had to be made tractable under constraints of notation, instruments, labor, materials, or institutions.
...
he designed geared machines to mechanize finite differences and later general symbolic operations. The system can be analyzed as inputs, representation, operations, checks, and outputs. Engineering history becomes clear when the contribution is read as a pipeline rather than as a slogan.
...
## Later systems
computer architecture, arithmetic logic units, control flow, memory, and tabulation engineering. The modern connection should be understood through mechanism: what abstraction survived, what constraint disappeared, and what new system became possible.
