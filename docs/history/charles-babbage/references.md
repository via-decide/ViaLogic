# Charles Babbage — references

- **Validation ID:** VIA-HIST-CHARLES-BABBAGE-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Charles Babbage. This page separates local repository evidence from authoritative source categories needed for future expansion.

## Historical summary
The local metadata records the following contribution marker: Difference Engine and Analytical Engine designs.. Dates are recorded as birth `1791` and death `1871` when available in local metadata.

## Repository references
- `data/entities.json`
- profile path `people/charles-babbage/` where available
- this history package under `docs/history/charles-babbage/`
...
- **Contribution marker:** local history package and local metadata: Difference Engine and Analytical Engine designs..
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Charles Babbage.
