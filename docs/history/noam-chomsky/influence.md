...
- **Validation ID:** VIA-HIST-NOAM-CHOMSKY-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Noam Chomsky; Noam Chomsky's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: Noam Chomsky · Classical..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Noam Chomsky]
  Person --> Contribution[Noam Chomsky · Classical.]
