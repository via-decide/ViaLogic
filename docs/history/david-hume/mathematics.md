...
## Mathematical core
The mathematical core associated with David Hume is classification, argument structure, measurement, proportional reasoning, or formal concepts where applicable. The point is not that every historical actor used modern notation, but that later mathematics can identify the structure of the reasoning.
