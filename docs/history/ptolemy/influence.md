...
- **Validation ID:** VIA-HIST-PTOLEMY-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Ptolemy; Ptolemy's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: Ptolemy · Classical..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Ptolemy]
  Person --> Contribution[Ptolemy · Classical.]
