...
- **Repository source:** `people/grigori-perelman/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Grigori Perelman is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Grigori Perelman · Modern into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/grigori-perelman/)
...
The verified mathematical object associated with this package is: Grigori Perelman · Modern. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
