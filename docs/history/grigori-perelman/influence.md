# Grigori Perelman — influence

- **Validation ID:** VIA-HIST-GRIGORI-PERELMAN-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Grigori Perelman; Grigori Perelman's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: Grigori Perelman · Modern..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Grigori Perelman]
  Person --> Contribution[Grigori Perelman · Modern.]
