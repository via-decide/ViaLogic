# Bal Gangadhar Tilak — references

- **Validation ID:** VIA-HIST-BAL-GANGADHAR-TILAK-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Bal Gangadhar Tilak. This page separates local repository evidence from authoritative source categories needed for future expansion.
...
- `data/entities.json`
- profile path `people/bal-gangadhar-tilak/` where available
- this history package under `docs/history/bal-gangadhar-tilak/`
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Bal Gangadhar Tilak.
