...
- **Validation ID:** VIA-HIST-RICHARD-FEYNMAN-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Richard Feynman. This page separates local repository evidence from authoritative source categories needed for future expansion.

## Historical summary
The local metadata records the following contribution marker: QED path integrals; Feynman diagrams; engineering safety evidence in Challenger inquiry.. Dates are recorded as birth `1918` and death `1988` when available in local metadata.

## Repository references
- `data/entities.json`
- profile path `people/richard-feynman/` where available
- this history package under `docs/history/richard-feynman/`
...
- **Contribution marker:** local history package and local metadata: QED path integrals; Feynman diagrams; engineering safety evidence in Challenger inquiry..
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Richard Feynman.
