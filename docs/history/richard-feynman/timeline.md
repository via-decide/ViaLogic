...
|---|---|---|
| 1918 | Birth / earliest historical marker. | External verification required in references. |
| Modern | Main period of work represented by ViaLogic. | Repository era metadata. |
| 1988 | Death / living status marker. | External verification required in references. |
