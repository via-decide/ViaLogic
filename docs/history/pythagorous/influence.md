# Pythagorous — influence

- **Validation ID:** VIA-HIST-PYTHAGOROUS-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Pythagorous; Pythagorous's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: Pythagorous · Classical..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Pythagorous]
  Person --> Contribution[Pythagorous · Classical.]
