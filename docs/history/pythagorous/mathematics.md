...
- **Repository source:** `people/pythagorous/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Pythagorous is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Pythagorous · Classical into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/pythagorous/)
...
The verified mathematical object associated with this package is: Pythagorous · Classical. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
