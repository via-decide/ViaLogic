...
- **Validation ID:** VIA-HIST-MARCUS-AURELIUS-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Marcus Aurelius; Marcus Aurelius's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: Marcus Aurelius · Classical..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Marcus Aurelius]
  Person --> Contribution[Marcus Aurelius · Classical.]
