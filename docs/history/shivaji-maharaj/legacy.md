...
- **Validation ID:** VIA-HIST-SHIVAJI-MAHARAJ-LEGACY
- **Version:** 1.1
...
## Engineering summary
Shivaji Maharaj's legacy is evaluated by whether local profile requires authoritative expansion. became part of later technical reasoning, scientific education, institutional practice, or engineered systems.
