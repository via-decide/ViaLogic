# Shivaji Maharaj — references

- **Validation ID:** VIA-HIST-SHIVAJI-MAHARAJ-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Shivaji Maharaj. This page separates local repository evidence from authoritative source categories needed for future expansion.
...
- `data/entities.json`
- profile path `people/shivaji-maharaj/` where available
- this history package under `docs/history/shivaji-maharaj/`
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Shivaji Maharaj.
