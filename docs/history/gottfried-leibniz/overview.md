...
- **Repository source:** `people/gottfried-leibniz/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Gottfried Leibniz is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Gottfried Leibniz · Enlightenment into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/gottfried-leibniz/)
...
## Who they were
Gottfried Leibniz (repository does not specify–repository does not specify) is included because the repository associates them with science.
