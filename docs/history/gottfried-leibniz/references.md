# Gottfried Leibniz — references

- **Validation ID:** VIA-HIST-GOTTFRIED-LEIBNIZ-REFERENCES
- **Version:** 1.1
...
## Engineering summary
References are the audit trail for claims about Gottfried Leibniz. This page separates local repository evidence from authoritative source categories needed for future expansion.

## Historical summary
The local metadata records the following contribution marker: Gottfried Leibniz · Enlightenment.. Dates are recorded as birth `not specified in local metadata` and death `not specified in local metadata` when available in local metadata.

## Repository references
- `data/entities.json`
- profile path `people/gottfried-leibniz/` where available
- this history package under `docs/history/gottfried-leibniz/`
...
- **Contribution marker:** local history package and local metadata: Gottfried Leibniz · Enlightenment..
...
## Modern relevance
A historical engineering platform is only useful if claims can be audited. This page defines the evidence boundary for Gottfried Leibniz.
