...
astronomers could predict planets empirically but lacked a unified mechanics explaining terrestrial and celestial motion. This was an engineering problem in the broad sense: a repeated human difficulty had to be made tractable under constraints of notation, instruments, labor, materials, or institutions.
...
he formulated laws of motion and universal gravitation with mathematical methods for changing quantities. The system can be analyzed as inputs, representation, operations, checks, and outputs. Engineering history becomes clear when the contribution is read as a pipeline rather than as a slogan.
...
## Later systems
mechanical engineering, orbital mechanics, control, simulation, and structural dynamics. The modern connection should be understood through mechanism: what abstraction survived, what constraint disappeared, and what new system became possible.
