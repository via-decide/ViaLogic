...
- **Repository source:** `people/thales/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Thales is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about Thales · Classical into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/thales/)
...
The verified mathematical object associated with this package is: Thales · Classical. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
