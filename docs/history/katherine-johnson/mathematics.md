...
- **Repository source:** `people/katherine-johnson/`, `data/entities.json`, `people-registry.json`
- **Research source list:** see `references.md` in this package.

## Engineering summary
Katherine Johnson is represented in ViaLogic as a science figure. The engineering knowledge package maps repository claims about NASA trajectory calculations into problems, constraints, solution mechanisms, and later system impact.
...
- **Repository links:** [ViaLogic profile](../../people/katherine-johnson/)
...
## Mathematics used
- Arithmetic, geometry, logic, algebra, analysis, probability, mechanics, or field mathematics as applicable to orbital mechanics.

## Theories / algorithms / equations
The verified mathematical object associated with this package is: NASA trajectory calculations. Detailed proofs must be tied to primary texts or university-level histories in `references.md`.
