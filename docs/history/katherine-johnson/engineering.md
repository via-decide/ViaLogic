...
crewed spaceflight required trajectories accurate enough to protect astronauts under tight physical constraints. This was an engineering problem in the broad sense: a repeated human difficulty had to be made tractable under constraints of notation, instruments, labor, materials, or institutions.
...
she computed launch windows, orbital paths, and reentry checks with analytic geometry and numerical care. The system can be analyzed as inputs, representation, operations, checks, and outputs. Engineering history becomes clear when the contribution is read as a pipeline rather than as a slogan.
...
## Later systems
space navigation, flight dynamics, verification culture, and mission safety. The modern connection should be understood through mechanism: what abstraction survived, what constraint disappeared, and what new system became possible.
