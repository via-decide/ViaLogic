# Katherine Johnson — influence

- **Validation ID:** VIA-HIST-KATHERINE-JOHNSON-INFLUENCE
- **Version:** 1.1
...
## Engineering summary
Influence is represented as a directed relationship: prerequisites flow into Katherine Johnson; Katherine Johnson's contribution flows into later theories, technologies, or institutions.

## Historical summary
The verified local contribution marker is: NASA trajectory calculations..

## Directed knowledge graph
```mermaid
graph TD
  Prior[Earlier traditions and prerequisite problems] --> Person[Katherine Johnson]
  Person --> Contribution[NASA trajectory calculations.]
...
## Influenced by
- Earlier practitioners in orbital mechanics.
