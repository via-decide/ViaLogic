...
```mermaid
graph LR
  A[Earlier practices and inherited problems] --> B[Katherine Johnson]
  B --> C[orbital mechanics]
  C --> D[space navigation, flight dynamics, verification culture, and mission safety]
```

## Influenced by
Katherine Johnson should be read against earlier tools, teachers, texts, institutions, and technical needs. Influence is strongest when a source shows direct reading, correspondence, apprenticeship, translation, patronage, or explicit criticism.
